...
#####################ISP GPIO###############################
set_property PACKAGE_PIN A14 [get_ports isp_alu_cs]
set_property IOSTANDARD LVCMOS33 [get_ports isp_alu_cs]

set_property PACKAGE_PIN A16 [get_ports isp_alu_sclk]
set_property IOSTANDARD LVCMOS33 [get_ports isp_alu_sclk]

set_property PACKAGE_PIN C15 [get_ports isp_alu_din]
set_property IOSTANDARD LVCMOS33 [get_ports isp_alu_din]

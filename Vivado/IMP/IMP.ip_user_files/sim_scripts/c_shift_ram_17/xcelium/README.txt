...
#
# Generated by export_simulation on Wed Jul 19 15:10:48 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_17.sh' script.

./c_shift_ram_17.sh -reset_run
...
./c_shift_ram_17.sh -noclean_files

For more information on the script, please type './c_shift_ram_17.sh -help'.

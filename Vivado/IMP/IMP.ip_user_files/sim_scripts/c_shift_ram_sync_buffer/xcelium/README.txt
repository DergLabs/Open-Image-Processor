...
#
# Generated by export_simulation on Thu Jul 20 03:07:26 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './c_shift_ram_sync_buffer.sh' script.

./c_shift_ram_sync_buffer.sh -reset_run
...
./c_shift_ram_sync_buffer.sh -noclean_files

For more information on the script, please type './c_shift_ram_sync_buffer.sh -help'.
